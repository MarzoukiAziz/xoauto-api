...
const NewAdSchema = new mongoose.Schema(
  {
    ...
    technical_sheet: {
      ...
      engine: { type: Map, of: String },
      transmission: { type: Map, of: String },
      dimensions: { type: Map, of: String },
      performance: { type: Map, of: String },
      consumption: { type: Map, of: String },
      safety_equipment: { type: Map, of: String },
      driving_aids: { type: Map, of: String },
      outdoor_equipment: { type: Map, of: String },
      multimedia: { type: Map, of: String },
      indoor_equipment: { type: Map, of: String },
      functional_equipment: { type: Map, of: String },
    },
